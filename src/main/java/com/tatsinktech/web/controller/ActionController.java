...
public class ActionController {
    ...
    public ModelMap getForm(@RequestParam(value = "id", required = false) Long id, Model model, @NotNull Authentication auth) {
        ...
        return new ModelMap("action", entity);
    }

    @PostMapping("/form")
    public String postForm(@Valid @ModelAttribute("action") Action entity,
    ...
    @PostMapping("/delete")
    public Object postDelete(@Valid @ModelAttribute("action") Action entity, SessionStatus status, Model model, @NotNull Authentication auth) {
        loadMode(model, auth);
        try {
